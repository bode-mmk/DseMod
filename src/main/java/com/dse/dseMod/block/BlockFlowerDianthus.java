...
public class BlockFlowerDianthus extends BlockCrops {
	public static final PropertyInteger FLOWER_AGE = PropertyInteger.create("age", 0, 1);
	private static final AxisAlignedBB[] FLOWER_AABB = new AxisAlignedBB[] {new AxisAlignedBB(0.15D, 0.0D, 0.15D, 0.85D, 0.8D, 0.85D), new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 1.0D, 1.0D)};

	public BlockFlowerDianthus() {
		super();
	}
	...
	public void getDrops(net.minecraft.util.NonNullList<ItemStack> drops, net.minecraft.world.IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		drops.add(new ItemStack(DseMod.BLOCK_ITEMS.flower_dianthus_tile_item, 1, 0));
	}
