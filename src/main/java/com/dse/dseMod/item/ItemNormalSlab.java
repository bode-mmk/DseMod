...
import com.dse.dseMod.block.BlockNormalSlab;
...
public class ItemNormalSlab extends ItemBlock {
    private final BlockNormalSlab singleSlab;
    private final BlockNormalSlab doubleSlab;

    public ItemNormalSlab(Block block, BlockNormalSlab singleSlab, BlockNormalSlab doubleSlab)
    {
        super(block);
