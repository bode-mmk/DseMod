...
import com.dse.dseMod.block.BlockDirectionedSlab;
...
public class ItemDirectionedSlab extends ItemBlock {
    private final BlockDirectionedSlab singleSlab;
    private final BlockDirectionedSlab doubleSlab;

    public ItemDirectionedSlab(Block block, BlockDirectionedSlab singleSlab, BlockDirectionedSlab doubleSlab)
    {
        super(block);
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        {
            Comparable<?> comparable = this.singleSlab.getTypeForItemByDirection(player.getHorizontalFacing());
    ...
    protected <T extends Comparable<T>> IBlockState makeState(IProperty<T> property, Comparable<?> compare)
    {
        return this.doubleSlab.getDefaultState().withProperty(property, (T)compare);
    }
}
